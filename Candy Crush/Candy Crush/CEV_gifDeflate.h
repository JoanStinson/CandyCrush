...
extern "C" {
	...
	typedef struct {/*Logical Screen Descriptor pack field, from byte*/
	...
	typedef struct {/*Logical Screen Descriptor Block*/
	...
	typedef struct {/*Graphics Control Extension pack field, from byte*/
		uint8_t res,
			disposalMethod,
			userInput,
			alphaFlag;
	...
	typedef struct {/*Graphics Control Extension*/
		uint8_t         byteSize,
			alphaColorIndex,
			used;
	...
	typedef struct {/*Image Descriptor packed file, from Byte*/
	...
	typedef struct {/*gif file descriptor*/
		L_GifHeader       header;
		L_GifLSD          lsd;
